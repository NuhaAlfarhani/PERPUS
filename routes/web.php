...
Route :: post('/anggota/tambah','App\Http\Controllers\AnggotaController@anggotatambah');
...
Route :: post('/petugas/tambah','App\Http\Controllers\PetugasController@petugastambah');
...
Route :: post('/pinjam/tambah','App\Http\Controllers\PinjamController@pinjamtambah');

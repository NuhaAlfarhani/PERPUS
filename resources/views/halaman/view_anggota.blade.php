                                    ...
                                    <div class="modal-body">
                                        ...
                                        <form name="formanggotaedit" id="formanggotaedit" action="/anggota/edit/{{ $a->id_anggota}} " method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-8">
                                                    <input type="text" class="form-control" id="nim" name="nik" placeholder="Masukan NIK">
                                                </div>
                                            </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form name="formanggotatambah" id="formanggotatambah" action="/anggota/tambah " method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="form-group row">
                            <label for="id_anggota" class="col-sm-4 col-form-label">NIK</label>
                            <div class="col-sm-8">
                        ...
                        <p>
                        <div class="form-group row">
                            <label for="prodi" class="col-sm-4 col-form-label">alamat</label>
                            <div class="col-sm-8">
